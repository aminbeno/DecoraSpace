                    ...
                    <div class="border-t border-gray-200 pt-6 mt-6">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full px-3">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="is_promoted" value="1" {{ old('is_promoted') ? 'checked' : '' }} class="form-checkbox h-5 w-5 text-lux-gold">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input type="number" name="promo_price" id="promo_price" value="{{ old('promo_price') }}" placeholder="Ex: 50000"
                                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            </div>
                            <div class="w-full md:w-1/2 px-3">
                                <label for="promo_label" class="block uppercase tracking-widest text-gray-700 text-xs font-bold mb-2">Label Promo</label>
                                <input type="text" name="promo_label" id="promo_label" value="{{ old('promo_label') }}" placeholder="Ex: Offre Spéciale"
                                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input type="datetime-local" name="promo_start_at" id="promo_start_at" value="{{ old('promo_start_at') }}"
                                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            </div>
                            <div class="w-full md:w-1/2 px-3">
                                <label for="promo_end_at" class="block uppercase tracking-widest text-gray-700 text-xs font-bold mb-2">Date de fin</label>
                                <input type="datetime-local" name="promo_end_at" id="promo_end_at" value="{{ old('promo_end_at') }}"
                                    class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            </div>
                        </div>
                    </div>
